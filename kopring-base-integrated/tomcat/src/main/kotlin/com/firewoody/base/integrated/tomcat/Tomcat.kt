package com.firewoody.base.integrated.tomcat
...
class Tomcat {
    ...
    fun servletController(
        ...
        userBodyEncodingForURI: Boolean,
        ...
        return TomcatServletWebServerFactory().apply {
            ...
            addProtocolHandlerCustomizers({
                if (it is AbstractProtocol<*>) {
                    ...
                    it.minSpareThreads = minSpareThread
                }
            ...
            addConnectorCustomizers({
                it.useBodyEncodingForURI = userBodyEncodingForURI
